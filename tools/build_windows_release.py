...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build and verify the RocketCatShell Windows release package"
    )
    ...
    expected_name = f"RocketCatShell-{args.tag}.zip"
    ...
    with tempfile.TemporaryDirectory(prefix="rocketcat-windows-release-") as temporary:
        temporary_root = Path(temporary)
        staging = temporary_root / PRODUCT_NAME
        staging.mkdir()
