...
def github_release(
    ...
    *,
    ...
    return {
        ...
        "draft": draft,
        "html_url": f"https://github.com/Creeper3222/RocketCat/releases/tag/{tag}",
        "assets": [
            {
                "name": asset_name,
        ...
        fallback = [
            {
                ...
                "prerelease": False,
                "notes": "fallback",
                "html_url": "https://github.com/Creeper3222/RocketCat/releases/tag/v0.2.2",
                "asset": {
    ...
    def test_download_enforces_final_host_size_and_digest(self) -> None:
        ...
        cases = (
            (
                ...
                "https://release-assets.githubusercontent.com/asset",
                f"sha256:{'0' * 64}",
                updates_module.MAX_WINDOWS_RELEASE_BYTES,
            ),
            (
